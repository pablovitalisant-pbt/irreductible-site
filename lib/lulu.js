...
function buildPlaceholderAddress(country) {
  ...
  // state_code required for US
  if (country === 'US') base.state_code = 'CA';
  // tax_id required and validated for CL, BR
  if (country === 'CL') base.recipient_tax_id = '11111111-1';
  if (country === 'BR') base.recipient_tax_id = '00000000000';
  return base;
}
